...
import grpc.course_service_pb2 as course__service__pb2
...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourse = channel.unary_unary(
                ...
                response_deserializer=course__service__pb2.GetCourseResponce.FromString,
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetCourse': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=course__service__pb2.GetCourseResponce.SerializeToString,
            ),
    }
...
class CourseService(object):
    ...
    def GetCourse(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            course__service__pb2.GetCourseResponce.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
