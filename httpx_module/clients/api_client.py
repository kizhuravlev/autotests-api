...
class APIClient:
    ...
    @allure.step("Sending a GET request to {url}")
    ...
    @allure.step("Sending a POST request to {url}")
    def post(
            self,
            url: URL | str,
            json: Any | None = None,
    ...
    @allure.step("Sending a PATCH request to {url}")
    ...
    @allure.step("Sending a DELETE request to {url}")
    def delete(
            self,
            url: URL | str,
    ) -> Response:
