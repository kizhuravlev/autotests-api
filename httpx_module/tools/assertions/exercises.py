...
def assert_create_exercise_response(request: CreateExerciseRequestSchema, response: CreateExerciseResponseSchema):
    """
    Проверяет, что ответ на создание задания соответствует переданному запросу.

    :param request: Запрос к API на создание задания
    :param response: Ответ от API на создание задания
    :raises AssertionError: Ответ на создание задания не соответствует запросу
    """
...
def assert_exercise(actual: ExerciseSchema, expected: ExerciseSchema):
    """
    Проверяет, что ответ на получение задания соответствует ответу создания задания.

    :param actual: Ответ от API на получение задания
    :param expected: Ответ от API на создание задания
    :raises AssertionError: Ответ на создание задания не соответствует запросу
    """
